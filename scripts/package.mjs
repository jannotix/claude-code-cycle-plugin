...
const required = ["dist/server.js", ".claude-plugin/plugin.json", ".mcp.json"]
...
const name = `cycle-${manifest.version}.zip`
...
console.log(`cycle ${manifest.version} — ${entries.length} files, ${mib(bytes)} uncompressed`)
