 ...
 * message read the stored row — so every commit Cycle delivered said "on 0 recorded gates" while
 * the journal beside it listed six. One function, read by both, is the fix; the test that asserts
